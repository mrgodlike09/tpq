...
<script>
  ...
  let createTableData = (shiftValue) => { // convert value to wanted table data value
    ...
    if (shiftValue == null) {
      tableData = '<a tabindex="0" data-placement="top" class="w-100 h-100 fa fa-times text-danger" role="button" data-toggle="popover" data-trigger="focus" title="Keterangan" data-content="Tidak Mengajar"></a>'
    ...
    for (i = 0; i < _global.absensi.length; i++) {
      ...
      if (i == _global.absensi.length - 1 || id_ust != _global.absensi[i + 1].id_ust) {
        ...
        <ul>
          ...
          <li>Tidak Mengajar : <strong>${_detail.alpa}</strong> * 0 = 0</li>
