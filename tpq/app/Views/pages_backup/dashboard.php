  ...
  let getShiftPagi = () => {
    ...
    for(i = 0; i < _global.absensi.length; i++) {
      shiftPagi+= `<ul class="list-item">
        ...
        <li
          style="color: ${_global.absensi[i].shift_pagi == null ? "var(--danger)" : (_global.absensi[i].shift_pagi[0] <= 1 ? "var(--success)" : "var(--purple)")  };
                  font-weight: 700;">
          ${_global.absensi[i].shift_pagi == null ? "Tidak Mengajar" : (_global.absensi[i].shift_pagi[0] <= 1 ? "Mengajar" : _global.absensi[i].shift_pagi)  }
          </li>
      </ul>
      `
    }
  ...
  let getShiftSiang = () => {
    ...
    for(i = 0; i < _global.absensi.length; i++) {
      shiftSiang+= `<ul class="list-item">
        <li>${_global.absensi[i].nama}</li>
        <li
          style="color: ${_global.absensi[i].shift_siang == null ? "var(--danger)" : (_global.absensi[i].shift_siang[0] <= 1 ? "var(--success)" : "var(--purple)")  };
                  font-weight: 700;">
          ${_global.absensi[i].shift_siang == null ? "Tidak Mengajar" : (_global.absensi[i].shift_siang[0] <= 1 ? "Mengajar" : _global.absensi[i].shift_siang)  }
          </li>
      </ul>
      `
    }
  ...
  let getShiftSore = () => {
    ...
    for(i = 0; i < _global.absensi.length; i++) {
      shiftSore+= `<ul class="list-item">
        <li>${_global.absensi[i].nama}</li>
        <li
          style="color: ${_global.absensi[i].shift_sore == null ? "var(--danger)" : (_global.absensi[i].shift_sore[0] <= 1 ? "var(--success)" : "var(--purple)")  };
                  font-weight: 700;">
          ${_global.absensi[i].shift_sore == null ? "Tidak Mengajar" : (_global.absensi[i].shift_sore[0] <= 1 ? "Mengajar" : _global.absensi[i].shift_sore)  }
          </li>
      </ul>
      `
    }
